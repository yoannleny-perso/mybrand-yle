...
const aboutPageSources: Record<Locale, AboutSourceCopy> = {
  ...
  fr: {
    ...
    description: "Opérateur-architecte avec une expérience de niveau VP dans la direction des opérations de données et de l'IA agentique à grande échelle. Parcours, principes et méthode de travail.",
    ...
    biography: { eyebrow: '01 — BIOGRAPHIE', body: [
      ...
      "Au moment où les grands modèles de langage ont cessé d'être une curiosité de recherche pour devenir des composants déployables, je pensais déjà aux agents — à des flux de travail qui devaient agir, et pas seulement chercher. Mon travail s'est alors orienté vers la conception de systèmes multi-agents dotés de garde-fous déterministes : graphes d'agents hiérarchiques, pistes d'audit, points de contrôle avec intervention humaine. Le modèle est devenu évident : l'IA agentique ne fonctionne en production que lorsqu'elle repose sur le même socle de données rigoureux dont les analyses traditionnelles ont besoin. Il n'y a pas de raccourci.",
    ...
    principles: { eyebrow: '02 — PRINCIPES', title: 'Ma méthode de travail.', items: [
      ...
      { number: '05', title: "Retirer plus qu'on n'ajoute.", description: 'La plupart des organisations se noient déjà. La retenue est la marque des grands professionnels.' },
    ] },
    trackRecord: { eyebrow: '03 — RÉSULTATS', metrics: [
      { label: 'IMPACT SUR LES REVENUS', value: '13M$+', description: "Impact cumulé sur les projets de données et d'IA, mesuré au niveau du compte de résultat — pas modélisé." },
      ...
      { label: 'DÉLAI DE RENTABILISATION', value: '9m', description: "Du lancement à la rentabilisation du plus récent projet de reconstruction d'infrastructure Medallion." },
  ...
  es: {
    ...
    description: 'Operador-arquitecto con experiencia a nivel VP liderando operaciones de datos e IA agéntica a gran escala. Antecedentes, principios y cómo trabajo.',
    ...
    portrait: { alt: 'Yoann Leny', caption: 'YOANN LENY · BURDEOS, FRANCIA', statement: 'Las herramientas son fáciles. La forma en que las decisiones, los datos, los modelos y las personas componen un todo que funciona — ahí es donde vive la palanca.' },
    biography: { eyebrow: '01 — BIOGRAFÍA', body: [
      ...
      'Para cuando los modelos de lenguaje grandes dejaron de ser una curiosidad de investigación y pasaron a ser componentes desplegables, yo ya había estado pensando en agentes — en flujos de trabajo que necesitaban actuar, no solo recuperar información. El trabajo se orientó hacia el diseño de sistemas multi-agente con límites deterministas: gráficos de agentes jerárquicos, pistas de auditoría, puntos de control con intervención humana. El patrón quedó claro: la IA agéntica funciona en producción solo cuando se asienta sobre los mismos cimientos de datos disciplinados que necesita la analítica tradicional. No hay atajos.',
    ...
    trackRecord: { eyebrow: '03 — TRAYECTORIA', metrics: [
      ...
      { label: 'EFICIENCIA', value: '+15%', description: 'Incremento sostenido del uso de un equipo de 40 personas tras desplegar el rastreador de habilidades agéntico.' },
      { label: 'TIEMPO DE AMORTIZACIÓN', value: '9m', description: 'Desde el inicio hasta la amortización en la reconstrucción más reciente de la pila medallion empresarial.' },
    ...
    stack: { eyebrow: '04 — TECNOLOGÍAS', body: 'Mis herramientas de trabajo diarias incluyen las principales plataformas de lakehouse y almacenamiento (Databricks, Snowflake, BigQuery), orquestación a través de Airflow y Dagster, transformación en dbt, capas semánticas a través de Cube y LookML (Looker), observabilidad a través de Monte Carlo y Lightdash, y marcos de agentes que incluyen LangGraph, CrewAI y, cada vez más, implementaciones de grafos deterministas personalizadas. La nube es múltiple (AWS, GCP, Azure) sin preferencia dogmática. Todo lo demás es un medio para un fin.' },
    writing: { eyebrow: '05 — PUBLICACIONES', items: [
      ...
      { label: 'Diseño de equipos para operaciones agénticas', href: '/es/insights/designing-teams-for-agentic-operations', kind: 'ensayo' },
...
const contactPages: Record<Locale, ContactCopy> = {
  en: {
    ...
    close: { title: 'Quiet conversations.', continuation: 'Better systems.', signature: '— Yoann', location: 'BORDEAUX, FR · GMT+1 · LANGUAGES: EN, FR, ES' },
  },
  fr: {
    title: 'Contact — Yoann Leny',
    ...
    hiring: { lead: 'Vous recrutez ?', body: "J'explore actuellement des postes de direction VP Data / Head of Data & AI — la version courte est sur la", link: { label: 'page de recrutement', href: '/fr/hire' } },
    paths: [
      { kind: 'email', label: 'E-MAIL DIRECT', actionLabel: 'yoann.leny@gmail.com', href: 'mailto:yoann.leny@gmail.com', description: 'Pour les présentations, les briefs de projets et les messages plus longs. Idéal pour les échanges avec des profils seniors.' },
      { kind: 'linkedin', label: 'LINKEDIN', actionLabel: 'Yoann Leny sur LinkedIn', href: 'https://www.linkedin.com/in/yoann-leny-10144b37/', external: true, description: "Pour les collègues, les recruteurs et le réseautage. Priorité inférieure à l'e-mail." },
  ...
  es: {
    ...
    paths: [
      ...
      { kind: 'linkedin', label: 'LINKEDIN', actionLabel: 'Yoann Leny en LinkedIn', href: 'https://www.linkedin.com/in/yoann-leny-10144b37/', external: true, description: 'Para colegas, reclutadores y redes de contactos. Menor prioridad que el correo electrónico.' },
      { kind: 'call', label: 'LLAMADA DE 30 MINUTOS', actionLabel: 'Solicitar un horario', href: 'mailto:yoann.leny@gmail.com?subject=Solicitud%20de%20llamada%20de%2030%20minutos', description: 'Un horario preseleccionado para conversaciones serias de proyectos. Utilice primero el correo electrónico si es un resumen largo.' },
    ],
...
const nowPageSources: Record<Locale, NowSourceCopy> = {
  ...
  fr: {
    ...
    focus: { title: 'Focus actuel', paragraphs: [
    ...
    availability: { title: 'Disponibilité', items: [
      { label: 'Postes de direction :', parts: [" J'explore activement des rôles de VP Data / Head of Data & AI dont le mandat est de construire ou reconstruire le système d'exploitation data et IA. Les détails — périmètre, localisation, langues — sont sur la ", { label: 'page de recrutement', href: '/fr/hire' }, '.'] },
...
const hirePages: Record<Locale, HireCopy> = {
  ...
  fr: {
    ...
    fit: { positiveTitle: 'Un bon fit quand', positive: ['La fonction data existe mais ne capitalise pas — des outils partout, de la confiance nulle part.', "L'IA agentique est à l'agenda du conseil et quelqu'un doit la rendre réelle, gouvernable et chiffrée.", "L'équipe compte 10 à 60 personnes et la contrainte est le modèle opérationnel, pas les effectifs.", 'Vous voulez un opérateur qui livre et exploite des systèmes, pas un stratège qui remet une présentation.'], negativeTitle: 'Un mauvais fit quand', negative: ['Le poste est un rôle de gardien — maintenir les tableaux de bord, ne rien changer.', "L'IA est voulue comme du théâtre : des démos pour le conseil, aucun appétit pour la gouvernance ou l'évaluation.", 'Le mandat porte la responsabilité des résultats sans autorité sur le modèle opérationnel.'] },
    plan: {
  ...
  es: {
    ...
    fit: { positiveTitle: 'Un buen encaje cuando', positive: ['La función de datos existe pero no capitaliza — herramientas en todas partes, confianza en ninguna.', 'La IA agéntica está en la agenda del consejo y alguien tiene que hacerla real, gobernable y con precio.', 'El equipo tiene entre 10 y 60 personas y la restricción es el modelo operativo, no la plantilla.', 'Quieren un operador que entrega y opera sistemas, no un estratega que entrega una presentación.'], negativeTitle: 'Un mal encaje cuando', negative: ['El rol es de cuidador — mantener los paneles encendidos, no cambiar nada.', 'La IA se quiere como teatro: demos para el consejo, sin apetito por la gobernanza o la evaluación.', 'El mandato tiene responsabilidad sobre los resultados pero sin autoridad sobre el modelo operativo.'] },
    plan: {
...
const capabilityPageSources: Record<Locale, CapabilitiesSourceCopy> = {
  ...
  fr: {
    ...
    engagement: { eyebrow: 'ENGAGEMENT', title: 'Comment débute notre collaboration.', summary: 'Trois modes, une seule exigence de qualité.', columns: ['Mode', 'Format', 'Durée type', 'Recommandé pour'], modes: [
      { mode: 'Architecte en résidence', shape: "Intégré un ou deux jours par semaine en tant qu'autorité architecturale principale.", duration: '6–18 mois', bestFor: "Les entreprises reconstruisant leur socle de données et d'IA." },
  ...
  es: {
    ...
    engagement: { eyebrow: 'CONTRATACIÓN', title: 'Cómo comienza una relación de trabajo.', summary: 'Tres modos, un solo estándar de calidad.', columns: ['Modo', 'Formato', 'Duración típica', 'Recomendado para'], modes: [
      { mode: 'Arquitecto en residencia', shape: 'Integrado uno o dos días a la semana como la autoridad arquitectónica principal.', duration: '6–18 meses', bestFor: 'Empresas que reconstruyen sus cimientos de datos y de IA.' },
    ...
    privacy: {
      ...
      paragraphs: [
        ...
        [
          ...
          { text: " L'hébergeur peut journaliser les requêtes (adresse IP, user agent) à des fins de sécurité et d'exploitation, comme le fait pratiquement tout hébergement." },
        ],
        [
          { text: 'Questions : ' },
          { text: 'yoann.leny@gmail.com', href: 'mailto:yoann.leny@gmail.com' },
    ...
    privacy: {
      ...
      paragraphs: [
        ...
        [
          ...
          { text: ' El proveedor de alojamiento puede registrar solicitudes (dirección IP, user agent) por motivos de seguridad y operativos, como lo hace prácticamente cualquier servicio de alojamiento.' },
        ],
        [
          { text: 'Preguntas: ' },
          { text: 'yoann.leny@gmail.com', href: 'mailto:yoann.leny@gmail.com' },
...
export const localizedSite: Record<Locale, LocalizedSiteCopy> = {
  ...
  fr: {
    ...
    home: {
      ...
      hero: {
        availability: 'Ouvert aux postes de direction senior Data & IA',
        location: 'Bordeaux · Europe',
      ...
      thinking: {
        ...
        items: [
          ...
          { label: 'Systèmes exécutifs', title: "Les dix chiffres d'un tableau de bord de PDG", slug: 'ten-numbers-ceo-dashboard' },
        ],
      },
      close: {
    ...
    work: {
      ...
      supporting: {
        ...
        cards: [
          ...
          { pattern: 'semantic', tag: 'Couche sémantique · IA', title: "Couche Sémantique prête pour l'IA", description: "Une couche de métriques repensée pour les LLM et les agents, standardisant la lecture de l'activité par les systèmes d'IA.", metrics: [{ value: '47', label: 'métriques' }, { value: '4', label: 'consommateurs IA' }, { value: '0', label: 'écart KPI' }], slug: 'ai-ready-semantic-layer' },
  ...
  es: {
    ...
    home: {
      ...
      thinking: {
        ...
        items: [
          ...
          { label: 'Sistemas ejecutivos', title: 'Los diez números de un dashboard de CEO', slug: 'ten-numbers-ceo-dashboard' },
        ],
      },
      close: {
    ...
    work: {
      ...
      intro: {
        ...
        summary: 'Una cartera real de productos, plataformas y sistemas operativos. Los dossiers con nombre propio están en preparación; los casos prácticos complementarios ya están disponibles.',
      },
      register: {
