...
const achievementDefinitions: AchievementDefinition[] = [
  {
    ...
    copy: {
      ...
      es: { summary: 'Un portal centralizado de reporting para la industria farmacéutica en Australia.', projectType: 'Portal de reporting', industry: 'Industria farmacéutica', location: 'Australia', status: 'Caso práctico en preparación', capabilities: ['Productos de datos', 'Reporting ejecutivo', 'Gobierno'] },
    },
  },
  {
    slug: 'polaris',
    ...
    copy: {
      ...
      es: { summary: 'Una forma más clara de gestionar las operaciones de personas.', projectType: 'Plataforma operativa', industry: 'Operaciones de personas', location: 'Confidencial', status: 'Caso práctico en preparación', capabilities: ['Modelo operativo', 'Estrategia de producto', 'Sistemas de decisión'] },
    },
  },
  {
    slug: 'lense-studio',
    ...
    copy: {
      ...
      es: { summary: 'Una forma automatizada de auditar dashboards y proponer mejoras.', projectType: 'Producto de auditoría con IA', industry: 'Analítica', location: 'Global', status: 'Caso práctico en preparación', capabilities: ['IA agéntica', 'Diseño de dashboards', 'Calidad automatizada'] },
    },
  },
  {
    slug: 'cap-ostrea',
    ...
    copy: {
      ...
      es: { summary: 'Un marketplace móvil para productores de ostras de la bahía de Arcachon.', projectType: 'Marketplace móvil', industry: 'Acuicultura', location: 'Bahía de Arcachon, Francia', status: 'Caso práctico en preparación', capabilities: ['Diseño de marketplace', 'Producto móvil', 'Operaciones locales'] },
    },
  },
  {
    ...
    copy: {
      ...
      es: { summary: 'Un sistema multiagente que conecta plataformas de medios y construye una arquitectura de datos preparada para la IA.', projectType: 'Sistema de datos multiagente', industry: 'Medios', location: 'Global', status: 'Caso práctico en preparación', capabilities: ['Sistemas multiagente', 'Integración de plataformas', 'Arquitectura preparada para IA'] },
    },
  },
];
